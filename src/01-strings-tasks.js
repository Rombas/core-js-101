...
function encodeToRot13(str) {
  ...
  for (let i = 0; i < str.length; i += 1) {
    ...
    if (charCode > 109 || (charCode > 77 && charCode < 91)) {
      res.push(str.charCodeAt(i) - 13);
    } else if ((charCode > 96 && charCode < 110) || (charCode > 64 && charCode < 78)) {
      res.push(str.charCodeAt(i) + 13);
    } else res.push(str.charCodeAt(i));
  }
